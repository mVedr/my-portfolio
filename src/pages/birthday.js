...
const birthday = () => {
  return (
    <div> <div class="confetti-container">
    <div class="confetti">
  ...
  <div class="card">
    ...
    <div class="inside">
      <p style="font-size: 20px;font-style: oblique;">Wishing you a very happy birthday filled with love and laughter</p>
      <h1>&#127873;</h1>
    </div></div></div>
  )
}
